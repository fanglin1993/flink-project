package com.scz.flink.orderpay_detect
...
object TxMatchByJoin {
  def main(args: Array[String]): Unit = {
    ...
    // 读取订单事件流
    val orderEventStream = env.readTextFile("data/flink/OrderLog.csv")
//    val orderEventStream = env.socketTextStream("localhost", 7777)
    ...
    // 读取支付到账事件流
    val receiptEventStream = env.readTextFile("data/flink/ReceiptLog.csv")
